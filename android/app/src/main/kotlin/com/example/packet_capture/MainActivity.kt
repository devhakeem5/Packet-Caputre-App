        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, METHOD_CHANNEL)
                .setMethodCallHandler { call, result ->
                    when (call.method) {
                        ...
                        "stopCapture" -> {
                            val intent =
                                    Intent(this, com.example.packet_capture.VpnService::class.java)
                            intent.action = "STOP"
                            startService(intent)
                            result.success(null)
                        }
                        "getInstalledApps" -> {
                            ...
                            android.util.Log.d(
                                    "PacketCapture",
                                    "Total packages found: ${apps.size}"
                            )
                                    ...
                                    if (!isSystemApp || isUpdatedSystemApp) {
                                        ...
                                        val icon =
                                                try {
                                                    ...
                                                    android.util.Log.e(
                                                            "PacketCapture",
                                                            "Error loading icon for $packageName",
                                                            e
                                                    )
                                                    null
                                                }
                            ...
                            android.util.Log.d(
                                    "PacketCapture",
                                    "Filtered app list size: ${appList.size}"
                            )
                        ...
                        "getAppPermissions" -> {
                            ...
                            try {
                                ...
                                if (requestedPermissions != null) {
                                    for (permName in requestedPermissions) {
                                        ...
                                        try {
                                            ...
                                            val description =
                                                    permInfo.loadDescription(pm)?.toString()
                                            ...
                                            if (groupName != null) {
                                                try {
                                                    val groupInfo =
                                                            pm.getPermissionGroupInfo(groupName, 0)
                                ...
                                result.error(
                                        "ERROR",
                                        "Failed to fetch permissions: ${e.message}",
                                        null
                                )
                            }
                        }
                        "openSecuritySettings" -> {
                            try {
                                ...
                                result.error(
                                        "ERROR",
                                        "Failed to open security settings: ${e.message}",
                                        null
                                )
                            }
                        }

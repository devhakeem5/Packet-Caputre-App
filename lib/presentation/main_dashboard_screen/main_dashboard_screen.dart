...
class MainDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Monitoring Tab Content (No AppBar, No internal TabBar)
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Obx(
            () => captureController.isRunning.value || trafficController.filteredRequests.isNotEmpty
                ? RefreshIndicator(
                            ...
                            child: Column(
                              children: [
                                ...
                                VpnStatusCardWidget(
                                  ...
                                  dataCaptured: "0 MB", // Should compute from trafficController
                                ),
                                SizedBox(height: 2.h),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Live Network Feed', style: theme.textTheme.titleMedium),
                                  ],
                                ),
                                SizedBox(height: 1.h),
                              ],
                            ...
                            : SliverList(
                                delegate: SliverChildBuilderDelegate((context, index) {
                                  ...
                                  return NetworkRequestItemWidget(
                                    ...
                                    onSaveRequest: () =>
                                        trafficController.toggleSaveRequest(request),
